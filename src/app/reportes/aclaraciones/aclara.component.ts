...
export class AclaracionesComponent implements OnInit  {
    ...
    public obtenDatosLog(result:object, numPag:number): void {
        ...
        this.dataJournalRedBlu        = JSON.parse(JSON.stringify(result));
        var idxReg = 0;
        var idxRegLog = 0;
        arrDatosJournal = [];
        this.numDatosLog = this.dataJournalRedBlu.length;
        ...
        if(this.numDatosLog > 0) {
            ...
            */
            ...
            this.dataJournalRedBlu = arrX;
            console.log(this.dataJournalRedBlu);
        }else{
